 ...
 * @param {number} newNumber - The new number of available seats.
 */
 ...
 * @returns {Promise<String>} A Promise that resolves to the current available seats count.
 */
 ...
 * @param {number} initialSeatsCount - The initial number of available seats.
 */
